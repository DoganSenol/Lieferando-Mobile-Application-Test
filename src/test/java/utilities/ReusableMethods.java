...
public class ReusableMethods {
    ...
    public static void scrollPage(String direction, int count) {
        for (int i = 0; i < count; i++) {
            scroll(direction, 1); // Sayfayı belirli bir miktar kaydır
            waitFor(2); // İstediğiniz kadar bekleme süresini ayarlayabilirsiniz
        }
    }
